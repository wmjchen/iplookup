# Vendored from https://github.com/gereoffy/pylibloc
# Commit: 21b095e850eaf0f2441b969aa21949c3b5facbbd
# License: LGPL-2.1 (see LICENSE in the upstream repo)
# Pure-Python reader for the IPFire Location database (location.db / location.db.xz).
